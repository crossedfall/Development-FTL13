...
/datum/ship_attack/laser/damage_effects(epicenter)
	explosion(epicenter,1,3,5,10,SSship.ship_combat_log_spam)
...
/datum/ship_attack/ballistic/damage_effects(epicenter)
	...
	for(var/i in 1 to rand(3,5))
		explosion(pick(clusters),max(0,rand(-4,1)),1,rand(3,6),0,SSship.ship_combat_log_spam)
		sleep(rand(5,10))
...
/datum/ship_attack/chaingun/damage_effects(turf/epicenter)
	...
	for(var/i in 1 to length)
		...
		explosion(p_T,1,2,rand(3,6),0,SSship.ship_combat_log_spam)
